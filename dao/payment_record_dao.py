...
class PaymentRecordDao:
    ...
    total_invoice_money: float # 应开票金额
    ...
    def __init__(self, id: str = '', from_company_id: str = "", to_company_id: str = "", payment_money: float = 0.0,
                 total_invoice_money: float = 0.0, has_invoice_money: float = 0.0,
                 remain_invoice_money: float = 0.0, invoice_content: str = "", status: int = 0, create_time: str = "") -> None:
        self.id = id
        self.from_company_id = from_company_id
        self.to_company_id = to_company_id
        self.payment_money = payment_money
        self.total_invoice_money = total_invoice_money
    ...
    def from_db(self, data: dict[str, Any]) -> None:
        ...
        self.total_invoice_money = float(data.get('total_invoice_money', 0.0))
