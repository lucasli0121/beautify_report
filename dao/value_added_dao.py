...
class ValueAddedDao:
    ...
    def from_db(self, data: dict[str, Any]) -> None:
        ...
        self.opened_input_tax = data.get('opened_input_tax', 0.0)
        self.opened_output_tax = data.get('opened_output_tax', 0.0)
        self.to_open_input_tax = data.get('to_open_input_tax', 0.0)
        self.to_open_output_tax = data.get('to_open_output_tax', 0.0)
        self.payable_tax = data.get('payable_tax', 0.0)
        self.sales_amount = data.get('sales_amount', 0.0)
        self.opened_billing_amount = data.get('opened_billing_amount', 0.0)
        self.remaining_billing_amount = data.get('remaining_billing_amount', 0.0)
