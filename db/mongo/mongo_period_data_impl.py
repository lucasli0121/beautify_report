...
class MongoPeriodDataImpl():
    ...
    return {*}
    """
    def query_by_id(self, id: str) -> tuple[bool, PeriodDataDao|None]:
        tbl_name = self.period_data_tbl()
        if tbl_name is None:
