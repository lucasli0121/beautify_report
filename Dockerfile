...
RUN mkdir /usr/share/fonts/chinese && cp /beautify_report/static/fonts/* /usr/share/fonts/chinese/
RUN cd /usr/share/fonts/chinese && fc-cache -f -v && fc-list

# Creates a non-root user with an explicit UID and adds permission to access the /app folder
# For more info, please refer to https://aka.ms/vscode-docker-python-configure-containers
RUN adduser -u 5678 --disabled-password --gecos "" appuser && chown -R appuser /beautify_report
USER appuser
